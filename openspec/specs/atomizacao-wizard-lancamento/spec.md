# Capability: Atomização do Wizard de Lançamento

## Purpose
Orquestrar a criação de lançamentos através de um processo guiado (wizard), garantindo clareza nas etapas e integridade dos dados coletados.
...
O sistema SHALL permitir la escolha inicial entre Despesa (PIX ou Cartão) e Empréstimo Pessoal.
