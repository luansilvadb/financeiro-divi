# Capability: Segregação de Fluxos Financeiros

## Purpose
Especializar os fluxos de processamento financeiro para distinguir entre despesas de consumo, empréstimos entre membros e acertos de saldo (netting).
