<template>
  ...
  <Transition name="slide-up">
    <div
      v-if="modelValue"
      class="fixed z-50 flex flex-col bg-card border-t md:border border-stone-surface shadow-2xl transition-all duration-300 text-graphite
             bottom-0 left-0 right-0 rounded-t-cardsLarge max-h-[90dvh]
             md:bottom-8 md:right-8 md:left-auto md:rounded-cards"
      :class="widthClass"
      :style="{ maxHeight }"
