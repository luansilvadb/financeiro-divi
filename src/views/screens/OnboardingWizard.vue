...
<template>
  <Transition name="fade" mode="out-in">
    ...
    <div v-if="etapaWizard === 4 && casaCriada" key="sucesso" class="text-center animate-in zoom-in-95 duration-200">
      <div class="mb-6">
    ...
    <div v-else-if="etapaWizard === 1" key="passo-nome" class="animate-in fade-in slide-in-from-right-2 duration-200">
      <header class="flex items-center gap-4 mb-6">
        <button @click="handleVoltar" class="w-9 h-9 rounded-full bg-stone hover:bg-ash/20 flex items-center justify-center text-charcoal transition-colors border-none cursor-pointer">
