<template>
  ...
  >
    ...
    <div class="flex flex-col items-center text-center space-y-6 pt-4">
      ...
      <div v-if="itemName || (itemValue !== undefined && itemValue !== null)" class="w-full p-4 rounded-2xl bg-parchment shadow-subtle border-none">
        <div class="flex justify-between items-center gap-4">
          <div class="text-left flex-1 min-w-0">
            ...
            <p class="text-sm font-bold text-charcoal truncate">{{ itemName || 'Sem descrição' }}</p>
          </div>
