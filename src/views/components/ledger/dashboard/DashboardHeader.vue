...
<template>
  <AppBar :scroll-ratio="scrollRatio" class="mb-4">
    ...
    <template #left>
      <button 
        class="flex items-center gap-2.5 text-left group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ember focus-visible:ring-offset-4 rounded-2xl px-3 py-1.5 transition-all duration-75 ease-out cursor-pointer active:scale-95 origin-left border border-stone/20"
        :style="{
    ...
    <template #center>
      <div 
        ...
        class="flex flex-col items-center justify-center select-none transition-all duration-75 ease-out relative"
        :style="{
      ...
      >
        ...
        <div 
          class="absolute transform animate-wobble z-0 opacity-80 pointer-events-none transition-all duration-75 ease-out"
          :style="{
        ...
        <div 
          class="relative mb-1.5 text-[8.5px] font-bold uppercase tracking-[0.2em] whitespace-nowrap flex items-center gap-2 justify-center text-ember transition-all duration-75"
        ...
        <h1 class="font-display text-3xl font-bold text-charcoal tracking-[-0.04em] leading-none relative z-10 transition-all duration-300">
      ...
      <div 
        v-else 
        class="flex flex-col items-center justify-center select-none relative px-4 transition-all duration-75 ease-out" 
      ...
      >
        ...
        <span class="text-[7.5px] font-bold text-ash/60 uppercase tracking-[0.25em] block leading-none mb-1.5 relative z-10 transition-opacity duration-200" :style="{ opacity: 1 - (2.8 * scrollRatio) }">Finanças Residenciais</span>
    ...
    <template #right>
      <button 
        ...
        class="flex items-center gap-2.5 text-right group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ember focus-visible:ring-offset-4 rounded-2xl px-3 py-1.5 transition-all duration-75 ease-out cursor-pointer active:scale-95 origin-right border border-stone/20"
        :style="{
      ...
      >
        ...
        <div class="w-8 h-8 rounded-full bg-white/40 flex items-center justify-center transition-all group-hover:bg-ember/10 group-hover:text-ember">
          <Bell class="w-4 h-4 transition-all duration-500 ease-jelly group-hover:scale-110 group-active:rotate-[-12deg]" aria-hidden="true" />
        </div>
      </button>
    </template>
  </AppBar>
