  ...
  <header class="flex items-center justify-between pb-6 pt-3 mb-8 border-b border-stone/50">
    ...
    <div class="flex-1 flex flex-col items-center justify-center text-center relative">
      ...
      <button 
        ...
        class="bg-transparent border-none cursor-pointer flex items-center justify-center gap-1 text-[10px] font-bold text-ember uppercase tracking-[0.15em] mb-1.5 relative z-10 hover:opacity-85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ember rounded-full px-2"
        aria-label="Trocar de casa"
      ...
      <span v-else class="text-[8px] font-semibold text-ash/80 uppercase tracking-[0.25em] block leading-none mb-1.5 relative z-10">Finanças Residenciais</span>
